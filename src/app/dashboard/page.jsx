...
export function DashboardContent() {
  ...
  const fetchOrderList = async () => {
      try {
        setLoading(true);
        const res=await axiosInstance.get(`/dashboard?order_type=0`)    
...
//  console.log("order data dashboard normal", orderData)
//  console.log("order data dashboard preorder", preOrderData)
const preOrderType=1
const regularOrderType=0
  const renderContent = () => {
